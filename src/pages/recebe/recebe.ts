...
@IonicPage()
@Component({
  selector: 'page-recebe',
  templateUrl: 'recebe.html',
})
export class RecebePage {

  ionViewDidLoad() {
    console.log('ionViewDidLoad RecebePage');
  }
                ...
                this.fileChooser.open().then(uri => {
                  ...
                  this.file.resolveLocalFilesystemUrl(uri).then(url => {
                    ...
                    this.file.readAsText(this.file.externalRootDirectory, 'Download/' + url.name).then(value => {
                      ...
                      this.listaStorage.setItem('LISTA2', this.lista2)
                        .then(
                      ...
                      this.listaStorage.setItem('ROMANEIO2', this.romaneio)
                        .then(
                          () => console.log('Stored item!'),
                          error => alert('Lista não gravada na memória interna -> ' + error)
                        );
            ...
            handler: () => {
              ...
              if (contagemTerminada) {
                ...
                let alert1 = this.alertCtrl.create(
                  {
                    title: 'EXISTEM DIVERGÊNCIAS NO RECEBIMENTO, A PRIMEIRA RECONTAGEM É OBRIGATÓRIA!!',
                    ...
                    buttons: [
                      //---botao 1
                      {
                        ...
                        handler: () => {
                          ...
                          // grava lista storage
                          this.listaStorage.setItem('LISTA', this.lista2)
                            .then(
                              () => console.log('Stored item!'),
                            );
